...
class Event(SqlAlchemyBase):
    ...
    category = sqlalchemy.Column(sqlalchemy.String, nullable=False, default='other')
    is_important = sqlalchemy.Column(sqlalchemy.Boolean, nullable=False, default=False)
    notify_minutes = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
